  ...
  return (
    <Layout>
      ...
      <div className="layout">
        {/* about us info */}
        <div className={styles.about__us} style={{ height: "100vh" }}>
          ...
          <div className={styles.about__content}>
            ...
            <p>
              ...
              like verifying all product before making them available for
              buying, verifying new users, assistance in buying process and
              always active customer service
            </p>
          </div>
        </div>
        <div className={styles.about__service}>
          ...
          <div className={styles.card}>
            ...
            <p>
              We always try to offer our best services to each customer in
              solving their issues sas soon as possible
            </p>
          </div>
        </div>
        {/* instructions */}
        <div className={styles.instructions__container}>
          ...
          <div className={styles.block}>
            ...
            <p>
              ...
              product thoroughly before buying and don&apos;t forget to chat
              with the user first
            </p>
          </div>
        </div>
